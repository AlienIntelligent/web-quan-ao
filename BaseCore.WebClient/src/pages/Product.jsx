  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        const p = pRes?.data;
        const vs =
          vRes?.data?.items && Array.isArray(vRes.data.items)
            ? vRes.data.items
            : [];
      ...
      <section className="product-details spad">
        <div className="container">
              ...
              <div className="product-details">
                <div className="pd-title-shopee mb-3">
                  ...
                  <div
                    ...
                    style={{ gap: "0", fontSize: "14px", height: "24px" }}
                  >
                    <div
                      className="d-flex align-items-center"
                      ...
                      >
                        {[...Array(5)].map((_, i) => (
                          <i
                            key={i}
                            className={
                              i < roundedAvg ? "fa fa-star" : "fa fa-star-o"
                            }
                            style={{
                              color: "#e7ab3c",
                              fontSize: "12px",
                ...
                <div
                  className="pd-vouchers d-flex align-items-center mb-4"
                  style={{ fontSize: "14px" }}
                >
                  <span className="text-muted" style={{ width: "110px" }}>
                    Mã Giảm Giá
                  </span>
                ...
                <div
                  className="pd-shipping d-flex align-items-center mb-4"
                  style={{ fontSize: "14px" }}
                >
                  <span
                  ...
                  <div className="d-flex align-items-center">
                    <div className="d-flex align-items-center mr-3">
                      <i
                        className="fa fa-truck mr-2"
                        style={{ color: "#00bfa5", fontSize: "16px" }}
                      ></i>
                      <span>
                        Vận chuyển tới <b className="ml-2">Toàn quốc</b>
                      </span>
                    </div>
                    <div
                      className="text-muted"
                ...
                <div className="pd-size-choose d-flex align-items-center mb-4">
                  ...
                  <div className="d-flex flex-wrap align-items-center">
                    ...
                    >
                      <i className="fa fa-question-circle"></i> Hướng dẫn chọn
                      size
                    </a>
                  </div>
                </div>
                ...
                <div className="quantity-section d-flex align-items-center mb-5">
                  <span
                    className="text-muted"
                    style={{ width: "110px", fontSize: "14px", flexShrink: 0 }}
                  >
                    Số lượng
                  </span>
                  <div
                    className="quantity-selector-shopee mr-3"
                    style={{
                ...
                <div
                  className="action-buttons d-flex mt-5"
                  style={{ gap: "15px" }}
                >
                  <button
                    type="button"
                    ...
                    style={{
                      backgroundColor: "rgba(231, 171, 60, 0.1)",
          ...
          <div className="product-details-content mt-5">
            <div
              className="pd-description-box mb-4 p-4 bg-white"
            ...
            <div
              className="pd-reviews-box p-4 bg-white"
              style={{ border: "1px solid #f0f0f0", borderRadius: "2px" }}
            >
              <h5
                className="mb-4"
              ...
              <div className="customer-review-option">
                <div
                  className="product-rating-summary d-flex align-items-center mb-4 p-4"
                  style={{
                ...
                {reviews.length === 0 ? (
                  ...
                  <div className="reviews-list">
                    {reviews.map((r) => (
                      <div
                        key={r.id}
                        className="review-item d-flex pb-4 mb-4 border-bottom"
                        style={{ gap: "15px" }}
                      >
                          ...
                          <div className="review-stars mb-2">
                            {[...Array(5)].map((_, i) => (
                              <i
                                key={i}
                                className={
                                  i < r.rating ? "fa fa-star" : "fa fa-star-o"
                                }
            ...
            >
              {relatedProducts.length === 0 ? (
                ...
                relatedProducts.map((rel) => {
                  const relImage =
                    rel.imageUrl || "/img/products/product-1.jpg";
                  ...
                  return (
                    ...
                    >
                      <div
                        className="product-item bg-white shadow-sm h-100"
                        style={{ border: "1px solid #f0f0f0" }}
                      >
                        <div
                          className="pi-pic product-square"
                          style={{ height: "190px" }}
                        >
                          <img
                            src={relImage}
            ...
            <div className="row mt-4">
              <div className="col-lg-12 text-center">
                <Link
                  ...
                  style={{ padding: "12px 40px", display: "inline-block" }}
                >
                  Xem thêm tất cả
                </Link>
              </div>
